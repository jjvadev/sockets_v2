        ...
        "cells": [
            ...
            },
            {
                ...
                "source": [
                    ...
                    "plt.plot(df['epoch'], df['train_cost'], marker='o', label='Costo Train')\n",
                    "plt.plot(df['epoch'], df['test_cost'], marker='s', label='Costo Test')\n",
                    ...
                    "plt.plot(df['epoch'], df['test_acc'], marker='s', label='Test Acc')\n",
                    ...
                    "\n",
                    "plt.figure(figsize=(8,5))\n",
                    "plt.plot(df['epoch'], df['train_acc'] - df['test_acc'], marker='o')\n",
